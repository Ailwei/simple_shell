...
**Project Duration:** Sep 6, 2023 6:00 AM - Sep 21, 2023 6:00 AM
...
First, remember the framework. If you do not know it by heart already, it is probably a good idea to read it again: [Simple Shell Framework](https://intranet.alxswe.com/concepts/559)

Note that there is no point in this framework that says it is okay to look at code from other people. It is not allowed to look at other people's code, either other students or online articles or videos. At ALX SE we do not copy solutions, and we do not look at them when we start a project.

In the context of learning (some of these will no longer be true when you work):

- NEVER copy any code, never look at solutions (and never give any solutions to your friends, you are not helping them by doing so).
...
The reality is that at this point of the program, if you have not cheated before, you have everything you need to complete the project with what you have learned + the page "Everything you need to know to start coding your own shell" [Shell Concept Page](https://intranet.alxswe.com/concepts/64).
...
So you are supposed to work TOGETHER. And you should both understand every single line of code that any of you pushes. Here is a link for you to read about pair programming: [Pair Programming Concept](https://intranet.alxswe.com/concepts/121)
